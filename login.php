...
<body>
    <div class="background--padrao">
        <div class="caixa--email--senha">
            ...
            <a href="./EsqueciSenha/esquecisenha.php"><div class="esqueci--senha">Esqueci minha senha</div></a>
            <a href="./Registre/registre.php"><div class="registre">Registre-se</div></a>
        </div>
    </div>
</body>
</html>